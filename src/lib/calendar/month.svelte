...
<div class="w-full lg:w-3/5 mx-auto border-secondary/30 dark:border-secondary/70 my-4 rounded-xl border p-3 py-2 shadow-2xl dark:shadow-secondary">
  ...
  <div class="grid w-full grid-cols-8 gap-1">
    {#each Array(4) as _, week_index}
      ...
      {#each days as d, day_index}
        <Day
          day_of_month={calculate_day(week_index, day_index)}
